...
path1=r"E:\Project\1-Output\0 PRE PROCESS\Dataset\Good\1-Alexa.csv"
path2=r"E:\Project\1-Output\0 PRE PROCESS\Dataset\Good\2-crowd flower.csv"
path3=r"E:\Project\1-Output\0 PRE PROCESS\Dataset\Good\3-DMOZ.csv"
path4=r"E:\Project\1-Output\0 PRE PROCESS\Dataset\Good\4-Benign.csv"
path5=r"E:\Project\1-Output\0 PRE PROCESS\Dataset\Good\5-Non Malicious.csv"
path6=r"E:\Project\1-Output\0 PRE PROCESS\Dataset\ISCXURL2016\URL\Benign_list_big_final.csv"
path7=r"E:\Project\1-Output\0 PRE PROCESS\Dataset\Malicious\1-Phishing site url.csv"
path8=r"E:\Project\1-Output\0 PRE PROCESS\Dataset\Malicious\2-Phishtank.csv"
path9=r"E:\Project\1-Output\0 PRE PROCESS\Dataset\Malicious\3-Malicious data url.csv"
path10=r"E:\Project\1-Output\0 PRE PROCESS\Dataset\ISCXURL2016\URL\phishing_dataset.csv"
path11=r"E:\Project\1-Output\0 PRE PROCESS\Dataset\Malicious\5-Phishstorm.csv"
path12=r"E:\Project\1-Output\0 PRE PROCESS\Dataset\Malicious\6-Malicious set.csv"
...
#Extract the 'url' feature from all the datasets
...
#This will generate six datasets containing both good and malicious URLs in equal ratio
result_dataset1.to_csv("(url,label)copy_of_combined_dataset1.csv", index=False)
result_dataset2.to_csv("(url,label)copy_of_combined_dataset2.csv", index=False)
result_dataset3.to_csv("(url,label)copy_of_combined_dataset3.csv", index=False)
result_dataset4.to_csv("(url,label)copy_of_combined_dataset4.csv", index=False)
result_dataset5.to_csv("(url,label)copy_of_combined_dataset5.csv", index=False)
result_dataset6.to_csv("(url,label)copy_of_combined_dataset6.csv", index=False)
