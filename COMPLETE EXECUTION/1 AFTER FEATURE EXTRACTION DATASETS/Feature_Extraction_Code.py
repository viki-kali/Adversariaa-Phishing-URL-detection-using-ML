...
# Function to count english letters
...
# Function to count Question Mark
...
# Function to count Hash Character
...
# Function to count Equals to Character
def EqualCount(str):
    count = 0
...
# Function to count Percentage Character
...
# Function to count Ampersand Character
...
# Function to count Dash Character
...
# Function to count At Character
def AtCharCount(str):
    count = 0
...
# Function to count Tilde Character
...
# Function to count Double Slash
...
# Function to calculate ratio of digits to alphabets
...
# Function to calculate ratio of special characters to alphabets
...
# Function to calculate ratio of uppercase letters to lowercase letters
def UppercaseLowercaseRatio(str):
    ucase = 0
    # Creating a set of uppercase letters
    uppercase = set("ABCDEFGHIJKLMNOPQRSTUVWXYZ")
    for num in str:
        if num in uppercase:
            ucase = ucase + 1
    lcase = 0
    # Creating a set of lowercase letters
...
# Function to find length of the URL
def URLLength(str):
    length = len(str)
    return length


# Function to compute entropy of the URL
...
#Function to check if IP address is used in hostname
...
#Function to find the length of the host name
def HostNameLength(str):
    parsed_url = urllib.parse.urlparse(str)
    return len(parsed_url.netloc)


#Function to find the length of the path of the URL
def PathLength(str):
    parsed_url = urllib.parse.urlparse(str)
    return len(parsed_url.path)


#Function to find the length of the Query of the URL
def QueryLength(str):
    parsed_url = urllib.parse.urlparse(str)
    return len(parsed_url.query)


#Function to find if there is https occurs in host name
...
# Function to calculate ratio of Domain length to URL length
...
#Function to find TLD of the URL
def TLD(str):
    try:
...
#Function to check if the URL is hashed or not
def is_hex(s):
...
#Function to check if TLD or ccTLD is used in the subdomain of website URL
...
#Function to check if TLD or ccTLD is used in the path of website URL
def TLDInPath(str):
    try:
        parsed_url = urllib.parse.urlparse(str)
        h = parsed_url.path
...
#Function to check if https is used in the website URL
def HttpsInUrl(str):
    res = "https"
    if res in str:
        return True
...
#Function to find the distance of digit to alphabet
...
#Function to check if the domain name is an English word
...
#Function to check whether the domain name is meaningful
...
#Function to check whether the domain name is pronounceable
...
#Function to check whether the domain name is random
...
#Function to calculate Unigram probability of the URL
def Unigram(str):
    concat_total_url = ''
...
#Function to calculate Bigram probability of the URL
def Bigram(str):
    concat_total_url = ''
    val_without_tld = (str.rsplit('.', 1))[0]
    concat_total_url = concat_total_url + val_without_tld
...
#Function to calculate Trigram probability of the URL
def Trigram(str):
    concat_total_url = ''
    val_without_tld = (str.rsplit('.', 1))[0]
    concat_total_url = concat_total_url + val_without_tld
...
#Function to count number of sensitive words in a webpage
...
# Function to check if the domain name is present in suspicious list
...
#Function to check if www is used in url
...
#Function to check if ftp:// is used in url
def FTPUsed(selfa):
    selfa = selfa.lower()
...
#Function to check if files is used in url
...
#Function to check if .js is used in url
def JSUsed(selfa):
    selfa = selfa.lower()
...
#Function to check if .css is used in url
def CSSUsed(selfa):
    selfa = selfa.lower()
...
#Function to check if any .exe file is contained in the URL
def CheckEXE(str):
...
#Function to count number of images in the webpage
def ImgCount(url):
    try:
        response = requests.get(url)
...
#Function to count the number of links used in the webpage
def TotalLinks(url):
    try:
...
#Function to find the age of domain since it is registered
...
#Function to check if HTML source code contains a JavaScript command to start a popup Window
def PopUpWindow(url):
    try:
...
#Function to check if HTML source code contains a JavaScript command on MouseOver to display a fake URL in the status bar 
...
#Function to find total number of query parameters in the URL
...
#Function to find total number of fragments in the URL
...
#Function to check distribution of word based feature
...
#Function to check presence of file extention
...
if __name__ == "__main__":
    ...
    data = pd.read_csv(r"E:\Project\1-Output\0 PRE PROCESS\(url,label)copy_of_combined_dataset1.csv", encoding= 'unicode_escape')
